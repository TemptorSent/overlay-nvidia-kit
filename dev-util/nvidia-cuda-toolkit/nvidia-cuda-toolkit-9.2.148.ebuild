...
SRC_URI="
	https://developer.nvidia.com/compute/cuda/${CUDA_VERSION}/Prod2/local_installers/${CUDA_PKGNAME} -> ${CUDA_PKGNAME}.run
	https://developer.nvidia.com/compute/cuda/${CUDA_VERSION}/Prod2/patches/1/${CUDA_PATCH1} -> ${CUDA_PATCH1}.run
"
